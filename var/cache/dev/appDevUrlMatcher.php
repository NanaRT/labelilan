    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/game')) {
            ...
            if (rtrim($pathinfo, '/') === '/game') {
                ...
                return array (  '_controller' => 'AppBundle\\Controller\\GameController::indexAction',  '_route' => 'game_index',);
            }
            not_game_index:

            // game_show
            if (preg_match('#^/game/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_game_show;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'game_show')), array (  '_controller' => 'AppBundle\\Controller\\GameController::showAction',));
            }
            not_game_show:
            ...
            if ($pathinfo === '/game/new') {
                ...
                return array (  '_controller' => 'AppBundle\\Controller\\GameController::newAction',  '_route' => 'game_new',);
            }
            not_game_new:
            ...
            if (preg_match('#^/game/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'game_edit')), array (  '_controller' => 'AppBundle\\Controller\\GameController::editAction',));
            }
            not_game_edit:

            // game_delete
            if (preg_match('#^/game/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_game_delete;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'game_delete')), array (  '_controller' => 'AppBundle\\Controller\\GameController::deleteAction',));
            }
            not_game_delete:
        ...
        if (0 === strpos($pathinfo, '/organizer')) {
            // organizer_index
            if (rtrim($pathinfo, '/') === '/organizer') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_organizer_index;
                }

                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'organizer_index');
                }

                return array (  '_controller' => 'AppBundle\\Controller\\OrganizerController::indexAction',  '_route' => 'organizer_index',);
            }
            not_organizer_index:

            // organizer_show
            if (preg_match('#^/organizer/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_organizer_show;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'organizer_show')), array (  '_controller' => 'AppBundle\\Controller\\OrganizerController::showAction',));
            }
            not_organizer_show:

            // organizer_new
            if ($pathinfo === '/organizer/new') {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_organizer_new;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\OrganizerController::newAction',  '_route' => 'organizer_new',);
            }
            not_organizer_new:

            // organizer_edit
            if (preg_match('#^/organizer/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_organizer_edit;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'organizer_edit')), array (  '_controller' => 'AppBundle\\Controller\\OrganizerController::editAction',));
            }
            not_organizer_edit:

            // organizer_delete
            if (preg_match('#^/organizer/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_organizer_delete;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'organizer_delete')), array (  '_controller' => 'AppBundle\\Controller\\OrganizerController::deleteAction',));
            }
            not_organizer_delete:
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'labelilan');
            }

            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::accueilAction',  '_route' => 'labelilan',);
        }
